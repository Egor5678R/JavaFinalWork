...
public class operationLaptopShop {
    ...
    public static void menu(){
        ...
        laptopShop laptop1 = new laptopShop("HUAWEI", "MateBook 16S", 16.0, "Windows 11 home", 16, 1024, "LPDDR5", "Intel", "Core i9 13900h", "Intel Iris Xe graphics", "grey", 133_000, "new", "Russian");
        ...
        laptopShop laptop9 = new laptopShop("MSI", "GF63 Thin", 15.6, "Windows 11 home", 16, 512, "DDR4", "Intel", "Core i5 11400H", "Nvidea 3050 Ti", "black", 36_000, "used", "Russian");
        laptopShop laptop10 = new laptopShop("SAMSUNG", "Galaxy Book 3 Pro 360", 16.0, "Windows 11 home", 16, 512, "LPDDR5", "Intel", "Core i5 1340P", "Intel Iris Xe graphics", "dark-grey", 196_000, "new", "Russian");
        ...
        laptopShop laptop25 = new laptopShop("SAMSUNG", "Galaxy Book S", 13.3, "Windows 10 pro", 8, 256, "LPDDR4x", "Intel", "Core i5 1135G7", "Intel Iris Xe graphics", "grey", 94_000, "new", "Russian");
        laptopShop laptop26 = new laptopShop("SAMSUNG", "Chromebook Plus V2", 12.2, "ChromeOS", 4, 64, "LPDDR3", "Intel", "Celeron 3965Y", "Intel HD Graphics", "silver", 42_000, "used", "English");
        laptopShop laptop27 = new laptopShop("GIGABYTE", "Aorus 15P", 15.6, "Windows 10 home", 16, 1024, "DDR4", "Intel", "Core i7 10750H", "Nvidea 1660 Ti", "black", 105_000, "new", "Russian");
        laptopShop laptop28 = new laptopShop("GIGABYTE", "Aero 17 HDR", 17.3, "Windows 11 pro", 32, 1024, "DDR4", "Intel", "Core i9 11900H", "Nvidea 3080", "black", 370_000, "new", "Russian");
        laptopShop laptop29 = new laptopShop("RAZER", "Book 13", 13.4, "Windows 11 home", 16, 512, "DDR4", "Intel", "Core i7 1165G7", "Intel Iris Xe graphics", "black", 192_000, "new", "English");
        laptopShop laptop30 = new laptopShop("RAZER", "Blade Stealth 13", 13.3, "Windows 10 pro", 16, 512, "DDR4", "Intel", "Core i7 1165G7", "Nvidea 1650Ti", "black", 140_000, "used", "Russian");
        laptopShop laptop31 = new laptopShop("HP", "Spectre x360", 13.3, "Windows 11 home", 8, 256, "LPDDR4x", "Intel", "Core i7 1165G7", "Intel Iris Xe graphics", "black", 160_000, "new", "English");
        laptopShop laptop32 = new laptopShop("HP", "ENVY x360", 15.6, "Windows 11 home", 16, 512, "DDR4", "AMD", "Ryzen 7 5800U", "AMD Radeon", "silver", 110_000, "new", "English");
        laptopShop laptop33 = new laptopShop("ACER", "Predator Triton 500", 15.6, "Windows 11 pro", 32, 1024, "DDR4", "Intel", "Core i7 11800H", "Nvidea 3080", "black", 275_000, "new", "English");
        laptopShop laptop34 = new laptopShop("ACER", "Aspire 5 slim", 15.6, "Windows 10 home", 8, 256, "LPDDR4x", "AMD", "Ryzen 5 5500U", "AMD Radeon", "silver", 50_000, "used", "Russian");
        laptopShop laptop35 = new laptopShop("HUAWEI", "MateBook X pro", 13.9, "Windows 10 home", 16, 512, "LPDDR4x", "Intel", "Core i7 1165G7", "Intel Iris Xe graphics", "grey", 180_000, "new", "English");
        laptopShop laptop36 = new laptopShop("APPLE", "MacBook pro 13", 13.3, "MacOS", 8, 256, "LPDDR4x", "Apple", "M1", "Apple graphics", "grey", 145_000, "new", "English");
        laptopShop laptop37 = new laptopShop("ASUS", "ZenBook Duo", 14.0, "Windows 11 home", 16, 512, "LPDDR4x", "Intel", "Core i5 1135G7", "Intel Iris Xe graphics", "white", 120_000, "new", "Russian");
        laptopShop laptop38 = new laptopShop("MSI", "GE66 Raider", 15.6, "Windows 11 home", 32, 1024, "DDR4", "Intel", "Core i9 11980HK", "Nvidea 3080", "black", 300_000, "used", "Russian");
        laptopShop laptop39 = new laptopShop("SAMSUNG", "Galaxy Book Flex 2", 15.6, "Windows 11 home", 16, 512, "LPDDR4x", "Intel", "Core i7 1165G7", "Intel Iris Xe graphics", "Mystic Bronze", 165_000, "new", "English");
        laptopShop laptop40 = new laptopShop("GIGABYTE", "Aero 17", 17.3, "Windows 11 pro", 64, 2048, "DDR4", "Intel", "Core i9 11900H", "Nvidea 3080", "black", 380_000, "new", "English");
        laptopShop laptop41 = new laptopShop("DELL", "Inspiron 15", 15.6, "Windows 11 home", 8, 256, "LPDDR4x", "Intel", "Core i7 1165G7", "Intel Iris Xe graphics", "black", 75_000, "used", "English");
        laptopShop laptop42 = new laptopShop("HP", "Pavilion Gaming", 15.6, "Windows 11 home", 16, 512, "DDR4", "AMD", "Ryzen 9 5900HX", "Nvidea 3050", "black", 110_000, "new", "Russian");

        HashSet<laptopShop> laptops = new HashSet<laptopShop>(
                Arrays.asList(laptop, laptop1, laptop2, laptop3, laptop4, laptop5, laptop6, laptop7, laptop8, laptop9, laptop10, laptop11, laptop12, laptop13, laptop14, laptop15,laptop16,laptop17,laptop18,laptop19,laptop20,laptop21,laptop22,laptop23,laptop24,laptop25,laptop26,laptop27,laptop28,laptop29,laptop30,laptop31,laptop32,laptop33,laptop34,laptop35,laptop36,laptop37,laptop38,laptop39,laptop40,laptop41,laptop42));
        operationLaptopShop op = new operationLaptopShop();
        boolean fl = true;
